...
Note: Coverage breadth (%) is the fraction of reference positions covered by ≥1 read, while Consensus breadth (%) is the fraction of positions with a called (non-`N`) consensus base after consensus building. Consensus breadth is therefore the higher-stringency “HQ breadth” and is  the better breadth number to use for interpretation. See [`../submission/all_options.md`](../submission/all_options.md).
