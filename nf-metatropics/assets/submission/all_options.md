...
| `--virasign_zscore_controls` | Override auto-detection with sample IDs and/or FASTQ paths (≥2 controls). Examples: --zscore-controls H20_1,H20_2,BG_1,BG_2, --zscore-controls /path/water1.fastq.gz,/path/water2.fastq.gz, or --zscore-controls water_controls.txt (one sample ID or path per line). |
